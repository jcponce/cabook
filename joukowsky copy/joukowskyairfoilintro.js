...
let P = (t, x, y) => speed * (   (2 * a*a * U * y*y)/(((x-posX)*(x-posX)+ (y-posY)*(y-posY))*((x-posX)*(x-posX)+ (y-posY)*(y-posY))) + U*(1 - (a*a)/((x-posX)*(x-posX)+ (y-posY)*(y-posY))) - (C*y)/(2*PI*((x-posX)*(x-posX)+ (y-posY)*(y-posY))) );//Change this function
let Q = (t, x, y) =>  speed * ( -(2*a*a * U * x * y)/(((x-posX)*(x-posX)+ (y-posY)*(y-posY))*((x-posX)*(x-posX)+ (y-posY)*(y-posY))) + (C * x)/(2*PI*((x-posX)*(x-posX)+ (y-posY)*(y-posY))) );//Change this function
